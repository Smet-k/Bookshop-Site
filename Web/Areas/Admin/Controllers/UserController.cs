...
namespace Web.Areas.Admin.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        (RoleManagementViewModel roleManagementViewModel)
        {
            ...
            if (!(roleManagementViewModel.ApplicationUser.Role == oldRole))
            {
                ...
                if (roleManagementViewModel.ApplicationUser.Role == SD.Role_Company)
                {
                    ...
                    roleManagementViewModel.ApplicationUser.CompanyId;
                }
                ...
                _userManager.AddToRoleAsync(applicationUser,
                roleManagementViewModel.ApplicationUser.Role)
                .GetAwaiter().GetResult();
            }
            else
        ...
        {
            List<ApplicationUser>? users = _unitOfWork.ApplicationUser?
        ...
        public IActionResult GetRange(int start, int end, string filter = "")
        {
            ...
            users = users.Skip(start).Take(end - start).ToList();
            return Json(new { data = users });
        }
        #endregion
    }
